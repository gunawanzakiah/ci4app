...
<head>
	...
	<style {csp-style-nonce}>
		...
		*:focus {
		...
		.second.content a:nth-child(1) {
			background-color: #ED1B2F;
			color: #fff;
		}

		.second.content a:nth-child(2) {
			background-color: #006cb8;
			color: #fff;
		}

		.second.content a:nth-child(3) {
			background-color: #ED1B2F;
			color: #fff;
		}

		.second.content a:nth-child(4) {
			background-color: #006cb8;
			color: #fff;
		}
	</style>
	...
	<header>
		...
		<div class="content">
			...
			<div class="second content">
				<a href="" class="item1">1</a>
				<a href="" class="item2">2</a>
				<a href="" class="item3">3</a>
				<a href="" class="item4">4</a>
				<a href="" class="item5">5</a>
				<a href="" class="item6">6</a>
				<a href="" class="item7">7</a>
				<a href="" class="item8">8</a>
